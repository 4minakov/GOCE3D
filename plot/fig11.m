...
surfm(rhoi.Lat_reg,rhoi.Lon_reg,(rhoi.d02d)*1e9), shading interp
c=colorbar(ax2,'Position',[0.7 0.65 0.015 0.15]); ylabel(c, 'Data [E]'); 
...
print('-dpng','-r400','../fig/fig11')
print('-depsc','-painters','-r300','../fig/fig11')
